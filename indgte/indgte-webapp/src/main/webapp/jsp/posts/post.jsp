		...
		<form class="form-promote" method="post" action="<c:url value='/o/promotepost/${post.id }' />" >
			<table>
				<tr>
					...
					<td><input type="text" id="start-date" name="startDate" readonly="readonly" placeholder="Click to choose" /></td>
				</tr>
				<tr>
					<td><label for="end-date">Promote until</label></td>
					<td><input type="text" id="end-date" name="endDate" readonly="readonly" placeholder="Click to choose"/></td>
				</tr>
			</table>
		</form>
