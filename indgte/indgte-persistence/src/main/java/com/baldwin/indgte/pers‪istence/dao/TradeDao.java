...
public interface TradeDao {
	...
	void sold(boolean moderator, String name, long itemId) throws IllegalAccessException;
	void delete(boolean moderator, String name, long itemId) throws IllegalAccessException;
	void available(boolean moderator, String name, long itemId) throws IllegalAccessException;
}
